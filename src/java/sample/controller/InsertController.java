...
public class InsertController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String productID=dao.createProductID(categoryID);
            Beverage beverage=new Beverage(productID, productName, price, quantity, categoryID);
            boolean check=dao.insertBeverage(beverage);
            if(check){
                url=SUCCESS;
            }
        } catch (Exception e) {
